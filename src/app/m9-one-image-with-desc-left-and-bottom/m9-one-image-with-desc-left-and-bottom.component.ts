...
@Component({
  selector: 'app-m9-one-image-with-desc-left-and-bottom',
  templateUrl: './m9-one-image-with-desc-left-and-bottom.component.html',
  styleUrls: ['./m9-one-image-with-desc-left-and-bottom.component.css']
})
export class M9OneImageWithDescLeftAndBottomComponent implements OnInit {
