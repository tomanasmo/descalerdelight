...
@Component({
  selector: 'app-m5-one-image-with-description',
  templateUrl: './m5-one-image-with-description.component.html',
  styleUrls: ['./m5-one-image-with-description.component.css']
})
export class M5OneImageWithDescriptionComponent implements OnInit {
