...
@Component({
  selector: 'app-m91-one-image-with-desc-right-and-top',
  templateUrl: './m91-one-image-with-desc-right-and-top.component.html',
  styleUrls: ['./m91-one-image-with-desc-right-and-top.component.css']
})
export class M91OneImageWithDescRightAndTopComponent implements OnInit {
