...
@Component({
  selector: 'app-m8-tripple-images-alternating',
  templateUrl: './m8-tripple-images-alternating.component.html',
  styleUrls: ['./m8-tripple-images-alternating.component.css']
})
export class M8TrippleImagesAlternatingComponent implements OnInit {
