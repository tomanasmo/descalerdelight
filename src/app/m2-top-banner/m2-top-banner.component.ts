...
@Component({
  selector: 'app-m2-top-banner',
  templateUrl: './m2-top-banner.component.html',
  styleUrls: ['./m2-top-banner.component.css']
})
export class M2TopBannerComponent implements OnInit {
