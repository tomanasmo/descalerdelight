...
@Component({
  selector: 'app-m3-three-points-banner',
  templateUrl: './m3-three-points-banner.component.html',
  styleUrls: ['./m3-three-points-banner.component.css']
})
export class M3ThreePointsBannerComponent implements OnInit {
