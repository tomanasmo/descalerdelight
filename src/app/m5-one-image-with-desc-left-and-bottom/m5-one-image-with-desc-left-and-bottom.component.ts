...
@Component({
  selector: 'app-m5-one-image-with-desc-left-and-bottom',
  templateUrl: './m5-one-image-with-desc-left-and-bottom.component.html',
  styleUrls: ['./m5-one-image-with-desc-left-and-bottom.component.css']
})
export class M5OneImageWithDescLeftAndBottomComponent implements OnInit {
