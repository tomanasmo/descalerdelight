...
@Component({
  selector: 'app-m4-three-horizontal-bar',
  templateUrl: './m4-three-horizontal-bar.component.html',
  styleUrls: ['./m4-three-horizontal-bar.component.css']
})
export class M4ThreeHorizontalBarComponent implements OnInit {
