...
@Component({
  selector: 'app-m13-whats-inside',
  templateUrl: './m13-whats-inside.component.html',
  styleUrls: ['./m13-whats-inside.component.css']
})
export class M13WhatsInsideComponent implements OnInit {
