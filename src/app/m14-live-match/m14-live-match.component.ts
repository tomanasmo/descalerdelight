...
@Component({
  selector: 'app-m14-live-match',
  templateUrl: './m14-live-match.component.html',
  styleUrls: ['./m14-live-match.component.css']
})
export class M14LiveMatchComponent implements OnInit {
