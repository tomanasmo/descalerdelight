...
@Component({
  selector: 'app-m7-one-image-with-desc-right-and-top',
  templateUrl: './m7-one-image-with-desc-right-and-top.component.html',
  styleUrls: ['./m7-one-image-with-desc-right-and-top.component.css']
})
export class M7OneImageWithDescRightAndTopComponent implements OnInit {
